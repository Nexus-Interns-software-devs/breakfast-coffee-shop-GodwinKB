...
## 🏗️ Starter Code (The Skeleton)
Node.js `readline` can be tricky when asking two questions in a row. To help you focus entirely on the JavaScript logic, you can copy/paste this skeleton to start your `coffee-shop.js` file:
